...
class Device(Base):
    ...
    interfaces = Column(ARRAY(String), nullable=True)  # Array of interface names
    services = Column(ARRAY(String), nullable=True)  # Array of running services
    ...
    allowed_users = Column(ARRAY(Integer), nullable=True)  # Array of user IDs
    allowed_actions = Column(ARRAY(String), nullable=True)  # Array of allowed actions
