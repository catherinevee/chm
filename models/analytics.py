...
class AnomalyDetection(Base):
    ...
    related_anomalies = Column(JSON, nullable=True)  # IDs of related anomalies
...
class AnalyticsInsight(Base):
    ...
    # Context and data
    related_devices = Column(JSON, nullable=True)  # Device IDs
    related_metrics = Column(JSON, nullable=True)  # Metric names
    related_anomalies = Column(JSON, nullable=True)  # Anomaly IDs
