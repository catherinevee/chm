"""
UUID patching module that must be imported before any SQLAlchemy models
"""

# Do the patching immediately on import
import sys
...
print("UUID patching applied from patch_uuid.py")