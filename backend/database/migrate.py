...
def create_initial_migration():
    ...
    try:
        ...
        print("PASS: Initial migration created successfully")
...
def upgrade_database(revision: str = "head"):
    ...
    try:
        ...
        print("PASS: Database upgraded successfully")
...
def downgrade_database(revision: str):
    ...
    try:
        ...
        print("PASS: Database downgraded successfully")
...
def create_new_migration(message: str):
    ...
    try:
        ...
        print("PASS: New migration created successfully")
